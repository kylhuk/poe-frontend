...
export const mockStashTabs: StashTab[] = [
  {
    ...
    items: [
      { id: 'i1', name: 'Mageblood', x: 0, y: 0, w: 2, h: 1, estimatedValue: 185, listedPrice: 180, currency: 'div', priceHealth: 'good', rarity: 'unique', itemClass: 'Belt' },
      { id: 'i2', name: 'Ashes of the Stars', x: 2, y: 0, w: 1, h: 1, estimatedValue: 12, listedPrice: 15, currency: 'div', priceHealth: 'bad', rarity: 'unique', itemClass: 'Amulet' },
      { id: 'i3', name: 'Bottled Faith', x: 0, y: 1, w: 1, h: 2, estimatedValue: 5.2, listedPrice: 5, currency: 'div', priceHealth: 'good', rarity: 'unique', itemClass: 'Flask' },
      { id: 'i4', name: 'Large Cluster Jewel', x: 3, y: 0, w: 1, h: 1, estimatedValue: 2.5, listedPrice: 1.8, currency: 'div', priceHealth: 'ok', rarity: 'rare', itemClass: 'Jewel' },
      { id: 'i5', name: 'Watcher\'s Eye', x: 4, y: 0, w: 1, h: 1, estimatedValue: 35, listedPrice: 30, currency: 'div', priceHealth: 'ok', rarity: 'unique', itemClass: 'Jewel' },
      { id: 'i6', name: 'Forbidden Flame', x: 1, y: 1, w: 1, h: 1, estimatedValue: 8, listedPrice: 8.5, currency: 'div', priceHealth: 'good', rarity: 'unique', itemClass: 'Jewel' },
      { id: 'i7', name: 'Thread of Hope', x: 2, y: 1, w: 1, h: 1, estimatedValue: 1.0, listedPrice: 0.5, currency: 'div', priceHealth: 'bad', rarity: 'unique', itemClass: 'Jewel' },
      { id: 'i8', name: 'Prism Guardian', x: 5, y: 0, w: 2, h: 3, estimatedValue: 0.1, listedPrice: 0.08, currency: 'div', priceHealth: 'good', rarity: 'unique', itemClass: 'Shield' },
    ],
  },
  {
    id: 'st2', name: 'Quad Dump', type: 'quad',
    items: [
      { id: 'q1', name: 'Divine Orb', x: 0, y: 0, w: 1, h: 1, estimatedValue: 1, listedPrice: 1, currency: 'div', priceHealth: 'good', rarity: 'normal', itemClass: 'Currency' },
      { id: 'q2', name: 'Void Battery', x: 3, y: 1, w: 1, h: 3, estimatedValue: 4.5, listedPrice: 3.8, currency: 'div', priceHealth: 'ok', rarity: 'unique', itemClass: 'Weapon' },
      { id: 'q3', name: 'Inspired Learning', x: 8, y: 0, w: 1, h: 1, estimatedValue: 1.2, listedPrice: 2.0, currency: 'div', priceHealth: 'bad', rarity: 'unique', itemClass: 'Jewel' },
      { id: 'q4', name: 'Aegis Aurora', x: 10, y: 5, w: 2, h: 2, estimatedValue: 6, listedPrice: 5.5, currency: 'div', priceHealth: 'good', rarity: 'unique', itemClass: 'Shield' },
      { id: 'q5', name: 'Brutal Restraint', x: 0, y: 10, w: 1, h: 1, estimatedValue: 3.5, listedPrice: null, currency: 'div', priceHealth: 'ok', rarity: 'unique', itemClass: 'Jewel' },
      { id: 'q6', name: 'The Squire', x: 15, y: 15, w: 2, h: 3, estimatedValue: 55, listedPrice: 50, currency: 'div', priceHealth: 'good', rarity: 'unique', itemClass: 'Shield' },
      { id: 'q7', name: 'Chaos Orb x20', x: 20, y: 0, w: 1, h: 1, estimatedValue: 0.15, listedPrice: null, currency: 'div', priceHealth: 'ok', rarity: 'normal', itemClass: 'Currency' },
      { id: 'q8', name: 'Replica Dreamfeather', x: 5, y: 18, w: 1, h: 3, estimatedValue: 12, listedPrice: 9, currency: 'div', priceHealth: 'ok', rarity: 'unique', itemClass: 'Weapon' },
      { id: 'q9', name: 'Enlighten Lvl 4', x: 18, y: 10, w: 1, h: 1, estimatedValue: 8, listedPrice: 7, currency: 'div', priceHealth: 'good', rarity: 'magic', itemClass: 'Gem' },
      { id: 'q10', name: 'Rare Astral Plate', x: 12, y: 20, w: 2, h: 2, estimatedValue: 15, listedPrice: 20, currency: 'div', priceHealth: 'bad', rarity: 'rare', itemClass: 'Body Armour' },
    ],
  },
];
